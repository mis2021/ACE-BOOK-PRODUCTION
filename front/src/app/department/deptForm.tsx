...
import TextArea from '@/components/admin/components/ui/text-area';
import Label from '@/components/admin/components/ui/label';
// import { useTypesQuery } from "@graphql/type.graphql";
import Card from '@/components/common/card';
import Description from '@/components/admin/components/ui/description';
import * as categoriesIcon from '@/components/icons/category';
import { getIcon } from '@/utils/get-icon';
import { useRouter } from 'next/router';
// import { ROUTES } from "@utils/routes";
import { getErrorMessage } from '@/utils/form-error';
import ValidationError from '@/components/admin/components/ui/form-validation-error';

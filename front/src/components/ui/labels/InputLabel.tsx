...
const InputLabelCont = (props: Props) => {
    return (
        <div className="flex mb-3 w-max">
            ...
            <span className="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-max text-sm p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                {props.value}
            </span>
        </div>
    )
